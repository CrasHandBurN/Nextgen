...
local replace_for_traffic_fromto_inner = {
	...
	{L"^ +Околовръстен Път ",L" Околовръстния Път "},
	{L"^ +Скоростен Път ",L" Скоростния Път "},
	{L"^ +(%S+)о +(%S+)о +НапівКолело +$", L" %1го %2го Півкільця "},
	{L"^ +(%S+)о +НапівКолело +$", L" %1го Півкільця "},
	{L"^ +(%S+)о +(%S+)о +Колело +$", L" %1то %2то Колело "},
	{L"^ +(%S+)о +Колело +$", L" %1то Колело "},
	{L"^ + [Тт] третото ", L" Третото "},
	{L"(.*) Път ",L" Пътя %1 "},
}
...
local replace_for_traffic_on_inner = {
	...
	{L"(.*) Трасе ",L" Трасето %1 "},
	{L"(.*) Шосе ",L" Шосето %1 "},
	{L"^ +Околовръстен Път ",L" Околовръстия Път "},
	{L"^ +Скоростен Път ",L" Скоростния Път "},
	{L"^ +(%S+)о +(%S+)о +Полуоколовръстно +$", L" %1то %2то Полуоколовръстното "},
...
local all_numbers_patternts = {
	...
	{L"едно",L"две",L"три",L"четири",L"пет",L"шест",L"седем",L"осем",L"девет",L"десет" ,L"единадесет",L"дванадесет",L"тринадесет",L"четиринадесет",L"петнадесет",L"шестнадесет",L"седемнадесет",L"осемнайсет",L"деветнайсет"}
}
