...
parameters = {
	[id.continue_left] = {then_cnt = 1, CID = 7101463, L"в ляво", L"в ляво", L"в ляво", L"левият"},	--левому
	[id.continue_right] = {then_cnt = 1, CID = 7101463, L"вдясно", L"вдясно", L"вдясно", L"десният"},	--правому
	[id.continue_sharp_left] = {then_cnt = 1, CID = 25189399, L"рязко", L"наляво", L"наляво", L"наляво", L"левият"},	--левому
	[id.continue_sharp_right] = {then_cnt = 1, CID = 25189399, L"рязко", L"надясно", L"надясно", L"надясно", L"десният"},	--правому
	[id.continue_uturn_left] = {then_cnt = 1, CID = 25189399, L"рязко", L"в ляво", L"в ляво", L"в ляво", L"левият"},	-- плавно, левому
	[id.continue_uturn_right] = {then_cnt = 1, CID = 25189399, L"рязко", L"вдясно", L"вдясно", L"вдясно", L"десният"},	--плавно, правому
	[id.deformed_roundabout_exit] = {then_cnt = 1, CID = 126618630, },
	[id.exit_left] = {then_cnt = 1, CID = 95162882, L"в ляво", L"в ляво", L"в ляво"},	--на изхода в ляво
	[id.exit_right] = {then_cnt = 1, CID = 95162882, L"вдясно", L"вдясно", L"вдясно"},	--на изхода вдясно
	...
	[id.keep_left_hwy] = {then_cnt = 1, CID = 104864258, L"в ляво", L"в ляво", L"в ляво"},	--по магистралата в ляво
	...
	[id.keep_right_hwy] = {then_cnt = 1, CID = 104864258, L"вдясно", L"вдясно", L"вдясно"},	--по магистралата вдясно
	[id.keep_right_shwy] = {then_cnt = 1, CID = 104864258, L"вдясно", L"вдясно", L"вдясно"},
	[id.left] = {then_cnt = 1, CID = 7101463, L"наляво", L"наляво", L"наляво", L"левият"},	--левому
	...
	[id.ramp_left] = {then_cnt = 1, CID = 7101463, L"в ляво", L"в ляво", L"в ляво", L"левият"},	--след островчето в ляво, левому
	[id.ramp_right] = {then_cnt = 1, CID = 7101463, L"вдясно", L"вдясно", L"вдясно", L"десният"},	--преди островчето вдясно, правому
	[id.right] = {then_cnt = 1, CID = 7101463, L"надясно", L"надясно", L"надясно", L"десният"},	--правому
	...
	[id.sharp_left] = {then_cnt = 1, CID = 25189399, L"рязко", L"наляво", L"наляво", L"наляво", L"левият"},
	[id.sharp_right] = {then_cnt = 1, CID = 25189399, L"рязко", L"надясно", L"надясно", L"надясно", L"десният"},
	[id.slight_left] = {then_cnt = 1, CID = 43267589, L"в ляво", L"в ляво", L"в ляво"},	--плавно в ляво
	[id.slight_right] = {then_cnt = 1, CID = 43267589, L"вдясно", L"вдясно", L"вдясно"},	--плавно вдясно
	[id.straight] = {then_cnt = 1, CID = 272901, },
	[id.uturn] = {then_cnt = 1, CID = 62652929, },
	[id.uturn_left] = {then_cnt = 1, CID = 25189399, L"рязко", L"в ляво", L"в ляво", L"в ляво", L"левият"},	--обратно
	[id.uturn_left_dual] = {then_cnt = 1, CID = 63186437, },
	[id.uturn_right] = {then_cnt = 1, CID = 25189399, L"рязко", L"вдясно", L"вдясно", L"вдясно", L"десният"},	--обратно
...
patterns = {
	L"След %poi продължете направо към %destname",
	L"След това на втория светофар продължете направо към %destname",
	L"След това на светофара продължете направо към %destname",
	L"След това продължете направо.",
	L"Продължете да следвате пътя, следващата маневра е след %dist .",
	L"След %dist продължете направо.",	-- далече
	L"След %dist %poi продължете направо към %destname  %then4",
	L"След %dist на втория светофар продължете направо към %destname  %then5",
	L"След %dist на светофара продължете направо към %destname  %then5",
	L"След %dist продължете направо по %streetname  %then",
	L"След %dist продължете направо %then",
	L"Продължете направо %then",
	L"след %poi завийте %1 към %destname",
	L"след това на втория светофар %1 към %destname",
	L"след това на светофара %1 към %destname",
	...
	L"След %dist %poi завийте %1 към %destname %then4",
	L"На втория светофар %1 към %destname %then5",
	L"На светофара %1 към %destname %then5",
	L"След %dist завийте %2 към %destname %then1",
	L"След %dist завийте %3 %then1",
	L"След %dist %3 %then1",
	L"След %dist %3 %then1",
	L"Сега %2 към %destname %then1",
	L"Сега %3 %then1",
	L"Завийте %3 %then1",
	L"Завийте %3 %then1",
	L"След %poi рязко %2 към %destname",
	L"След това на втория светофар завийте рязко %2 към %destname",
	L"След това на светофара рязко %2 към %destname",
	L"След това завийте %1 %4.",
	L"След това на третата пресечка завийте рязко %4.",
	L"След това на втората пресечка завийте рязко %4.",
	L"След това завийте рязко %4.",
	L"След %dist завийте рязко %4.",	-- далече
	L"След %dist %poi завийте рязко %2 към %destname  %then4",
	L"След %dist На втория светофар рязко %2 към  %destname  %then5",
	L"След %dist На светофара рязко %2 към %destname  %then5",
	L"След %dist %1 завийте %3 към %destname  %then1",
	L"След %dist %1 завийте %4 %then1",
	L"След %dist рязко %4 %then1",
	L"След %dist рязко %4 %then1",
	L"На кръстовището %1 %3 към  %destname %then1",	--повороте
	L"На кръстовището %1 %4 %then1",	--повороте
	L"Завийте %1 %3 към  %destname  %then1",
	L"Завийте %1 %4 %then1",
	L"След %poi плавно %1 към %destname",
	L"След това на втория светофар плавно %1 към %destname",
	L"След това на светофара плавно %1 към  %destname",
	L"След това плавно %3.",
	L"След %dist плавно %3.",	-- далече
	L"След %dist %poi плавно %1 към  %destname  %then4",
	L"След %dist На втория светофар плавно %1 към %destname  %then5",
	L"След %dist На светофара плавно %1 към %destname  %then5",
	L"След %dist плавно %2  към %destname  %then",
	L"След %dist плавно %3 %then",
	L"Плавно %2 към %destname  %then",
	L"Плавно %3 %then",
	L"След %poi дръжте %1 към %destname",
	L"След това дръжте %3",
	L"След %dist дръжте %3",	-- далече
	L"След %dist %poi дръжте %1 към %destname  %then4",
	L"След %dist дръжте %2 към %destname  %then",
	L"След %dist дръжте %3 %then",
	L"Дръжте %2 към %destname  %then",
	L"Дръжте %3 %then",
	L"След това продължете по главния път.",
	L"След %dist продължете по главния път.",	-- далече
	L"След %dist продължете по %streetname  %then",
	L"След %dist продължете по главния път %then",
	L"Продължете по главния път %then",
	L"След това дръжте %1 по главния път.",
	L"След %dist дръжте %1 по главния път.",			-- далече
	L"След %dist по %streetname  дръжте %3 %then",
	L"След %dist по главния път, дръжте %3 %then",
	L"Дръжте %1 по главния път %then",
	...
	L"След %dist влезете в кръговото.",
	L"След %dist на кръговото вземете %exit изход %destname  %then",
	L"След %dist на кръговото вземете %exit изход %then",
	L"След %dist влезте в кръговото  %destname  %then",
	L"След %dist кръгово движение %then",
	L"На кръговото излезте от %exit изход %then",
	L"Влезте в кръговото. %then",	--Дорога с круговым движением
	L"След това завийте %1 на кръговото.",
	L"След %dist на кръговото завийте %1.",
	L"След %dist на кръговото %1 като вземете %exit изход, %destname  %then",
	L"След %dist на кръговото %1 като вземете %exit изход %then",
	L"След %dist на кръговото %1 към %destname  %then",
	L"След %dist на кръговото %1 %then",
	L"На кръговото %1 като вземете %exit изход %then",
	L"На кръговото %1 %then",
	L"След това обърнете на кръговото.",
	L"След %dist обърнете на кръговото",			
	L"След %dist обърнете на кръговото, като вземете  %exit изход към %destname  %then",
	L"След %dist обърнете на кръговото, като вземете  %exit изход %then",
	L"След %dist обърнете на кръговото към %destname  %then",
	L"След %dist обърнете на кръговото %then",
	L"Направете обърнете на кръговото, като вземете %exit изход %then",
	L"Обърнете на кръговото %then",
	L"След това на кръговото продължете направо, като отстъпите пътя.",
	L"След %dist на кръговото продължете направо, като отстъпите пътя, ",
	L"След %dist на кръговото продължете направо, като вземете %exit изход, %destname  %then",
	L"След %dist на кръговото продължете направо, през %exit изход %then",
	L"След %dist на кръговото продължете направо към %destname  %then",
	L"След %dist на кръговото продължете направо %then",
	L"На кръговото, вземете %exit изход %then",
	L"На кръговото продължете направо %then",
	L"Вземете %exit изход към %destname  %then",
	L"Вземете %exit изход %then",
	L"Влезте в кръговото, %destname  %then",
	L"След това, излезте %3.",
	L"След %dist се пригответе да излезете %1.",	-- далече
	L"След %dist излезте %1 към %destname  %then",
...
---	L"След %dist излезте на %streetname %then3",			--- на основа от wwt-bull: иначе два пъти "на на"
	...
	L"След %dist се пригответе да се качите на ферибота.",	-- далече
	L"След %dist се качете на ферибота.",
	L"Качете се на ферибота.",
	L"Дължината на маршрута надвишава %dist",
	L"След %dist слезте от ферибота %then",
	L"там е спирката.",
	L"След %dist се пригответе да пристигнете в спирката си %waypointname",
	L"След %dist се пригответе да пристигнете в спирката си %waypointname %then",
	L"Пристигнахте спирката си %waypointname %then",
	L"там е дестинацията.",
	L"След %dist се пригответе да пристигнете в дестинацията си %waypointname",
	L"След %dist се пригответе да пристигнете в дестинацията си %waypointname",
	L"Пристигнахте дестинацията си %waypointname",
	L"там е спирката %3.",
	L"След %dist се пригответе да пристигнете в спирката си %waypointname %1.",
	L"След %dist се пригответе да пристигнете в спирката си %waypointname %1 %then",
	L"Пристигнахте спирката си %waypointname %3 %then",
	L"там е дестинацията %3.",
	L"След %dist се пригответе да пристигнете в дестинацията си %waypointname %1.",
	L"След %dist се пригответе да пристигнете в дестинацията си %waypointname %1.",
	...
	L"след това %1 %4.",
	L"След %dist %poi рязко %2 към %destname %then4",
	L"%poi рязко %2 към %destname %then4",
	L"%poi рязко %2 %then4",
	L"На втория светофар рязко %2 %then5",
	L"На светофара рязко %2 %then5",
	L"След %dist %1 %3 към %destname %then1",
	...
	L"%poi плавно %1 към %destname %then4",
	...
	L"Плавно %2 %then",
	L"след %poi дръжте %1.",
	L"%poi дръжте %1 към %destname %then4",
	...
	L"Дръжте %2 %then3",
	L"след това в края на пътя завийте %3.",
	L"След %dist %3 към %destname %then",
	L"След %dist %3 %then",
	L"След %dist %2 %then",
	L"След %dist в края на пътя %2 към %destname %then",
	L"След %dist в края на пътя %2 %then",
	L"След %dist в края на пътя %3 %then",
	L"на кръстовището %2 към %destname %then",
...
poi = {
	...
	{cat="Bridge",after=L"след моста",before=L"преди моста",by=L"на мосту",fromContent=0,},
	...
	{cat="Cafe_or_Bar",after=L"след кафето",before=L"преди кафето",by=L"при кафето",},
	...
	{cat="Petrol_Station\1Petrol",after=L"след бензиностанцията Петрол",before=L"преди бензиностанцията Петрол",by=L"при бензиностанцията Петрол",},
	{cat="Petrol_Station\1Rompetrol",after=L"след бензиностанцията Ромпетрол",before=L"преди бензиностанцията Ромпетрол",by=L"при Ромпетрол",},
	{cat="Petrol_Station\1Rosneft'",after=L"след бензиностанцията бензиностанцията Рос Нефт'",before=L"преди бензиностанцията бензиностанцията Рос Нефт'",by=L"при бензиностанцията бензиностанцията Рос Нефт'",},
