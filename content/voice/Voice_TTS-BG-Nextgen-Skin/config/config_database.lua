...
patterns = {
	L"След %poi продължете направо %destname",
	...
	L"След това на втория светофар завийте рязко %2 %destname",
	...
	L"След %dist обърнете на кръговото, като вземете  %exit изход %destname  %then",
	...
	L"След %dist на кръговото продължете направо %destname  %then",
