...
distances.patterns = {
   ...
   L"едно цяло и един",
	...
	L"двеста и трийсет",
	L"24",
	L"двеста и четиресет",
	L"25",
	L"двеста и петдесет",
	L"26",
	L"двеста и шейсет",
	L"27",
	L"двеста и седемдесет",
	L"28",
	L"двеста и осемдесет",
	L"29",
	L"двеста и деветдесет",
	L"3",
	L"три цяло и един",
	L"три цяло и два",
	L"3,3",
	...
	L"триста и трийсет",
	L"34",
	L"триста и четиресет",
	L"35",
	L"триста и петдесет",
	L"36",
	L"триста и шейсет",
	L"37",
	L"триста и седемдесет",
	L"38",
	L"триста и осемдесет",
	L"39",
	L"триста и деветдесет",
	L"4",
	L"четири цяло и един",
	L"четири цяло и два",
	L"4,3",
	L"4,4",
	L"4,5",
	...
	L"400",
        L"четиресет и един",
	L"четиристотин и десет",
        L"четиресет и два",
	L"четиристотин и двайсет",
	L"43",
	L"четиристотин и трийсет",
	L"44",
	L"четиристотин и четиресет",
	L"45",
	L"четиристотин и петдесет",
	L"46",
	L"четиристотин и шейсет",
	L"47",
	L"четиристотин и седемдесет",
	L"48",
	L"четиристотин и осемдесет",
	L"49",
	L"четиристотин и деветдесет",
	L"5",
	L"пет цяло и един",
	L"пет цяло и два",
	L"5,3",
	...
	L"петстотин и десет",
	L"петдесет и два",
	L"петстотин и двайсет",
	L"53",
	L"петстотин и трийсет",
	L"54",
	L"петстотин и четиресет",
	L"55",
	L"петстотин и петдесет",
	L"56",
	L"петстотин и шейсет",
	L"57",
	L"петстотин и седемдесет",
	L"58",
	L"петстотин и осемдесет",
	L"59",
	L"петстотин и деветдесет",
	L"6",
	L"шест цяло и един",
	L"шест цяло и два",
	L"6,3",
	...
	L"шестотин и десет",
	L"шейсет и два",
	L"шестотин и двайсет",
	L"63",
	L"шестотин и трийсет",
	L"64",
	L"шестотин и четиресет",
	L"65",
	L"шестотин и петдесет",
	L"66",
	L"шестотин и шейсет",
	L"67",
	L"шестотин и седемдесет",
	L"68",
	L"шестотин и осемдесет",
	L"69",
	L"шестотин и деветдесет",
	L"7",
	L"седем цяло и един",
	L"седем цяло и два",
	L"7,3",
	...
	L"700",
	L"седемдесет и един",
	L"седемстотин и десет",
	L"седемдесет и два",
	L"седемстотин и двайсет",
	L"73",
	L"седемстотин и трийсет",
	L"74",
	L"седемстотин и четиресет",
	L"75",
	L"седемстотин и петдесет",
	L"76",
	L"седемстотин и шейсет",
	L"77",
	L"седемстотин и седемдесет",
	L"78",
	L"седемстотин и осемдесет",
	L"79",
	L"седемстотин и деветдесет",
	L"8",
	L"осем цяло и един",
	L"осем цяло и два",
	L"8,3",
	...
	L"800",
	L"осемдесет и един",
	L"осемстотин и десет",
	L"осемдесет и два",
	L"осемстотин и двайсет",
	L"83",
	L"осемстотин и трийсет",
	L"84",
	L"осемстотин и четиресет",
	L"85",
	L"осемстотин и петдесет",
	L"86",
	L"осемстотин и шейсет",
	L"87",
	L"осемстотин и седемдесет",
	L"88",
	L"осемстотин и осемдесет",
	L"89",
	L"осемстотин и деветдесет",
	L"9",
	L"девет цяло и един",
	L"девет цяло и два",
	L"9,3",
	...
	L"900",
	L"деветдесет и един",
	L"деветстотин и десет",
	L"деветдесет и два",
	L"деветстотин и двайсет",
	L"93",
	L"деветстотин и трийсет",
	L"94",
	L"деветстотин и четиресет",
	L"95",
	L"деветстотин и петдесет",
	L"96",
	L"деветстотин и шейсет",
	L"97",
	L"деветстотин и седемдесет",
	L"98",
	L"деветстотин и осемдесет",
	L"99",
	L"деветстотин и деветдесет",
	L"Фут",
	L"Фут,",
L"Фут.",
L"Километър",
