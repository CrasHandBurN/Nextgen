...
local preposition_insert_tbl = {
	{L"в ",{L"Кръстовище",L"Проезд",L"Задръстване"}},
	{L"на ",{L""}},
}
...
local main_streetnames = {L"Булевард",L"Переулок",L"Площад",L"Авеню",L"Вилна зона",L"Улица"}
...
VOICE["replace_mapinfo_roadnumber_name" .. mother_country] = {
	{L"^ +(%S+) +$", function (s)
		...
		local t_roads = {
			...
			{L"Урал",L"М 5"},
			{L"Волга",L"М 7"},
			{L"Холмогори",L"М 8"},  --Холмогоры
			{L"Балтийско",L"М 9"},	--Балтия
			{L"Русия",L"М 10"},
			{L"Нева",L"М 11"},
			{L"Кола",L"Р 21"},
			{L"Каспийско",L"Р 22"},	-Каспий
			{L"Псков",L"Р 23"},
			{L"Вятка",L"Р 176"},
			{L"Кавказ",L"Р 217"},
			{L"Иртиш",L"Р 254"},
...
VOICE["replace_mapinfo" .. mother_country] = {
	...
	--- Вмъкване от drey95 - 09.07.19: Расшифровка номеров Дорог по первому номеру
...
VOICE["replace_mapinfo_end" .. mother_country] = {
	{L" +м[%. ]+(.* +Улица) +",L" Малка %1 "},
	{L" +б[%. ]+(.* +Улица) +",L" Голяма %1 "},
	{L" +м[%. ]+(.* +Переулок) +",L" Малый %1 "},
	{L" +б[%. ]+(.* +Переулок) +",L" Большой %1 "},
	{L" +м[%. ]+(.* +Задръстване) +",L" Малый %1 "},
	{L" +б[%. ]+(.* +Задръстване) +",L" Большой %1 "},
