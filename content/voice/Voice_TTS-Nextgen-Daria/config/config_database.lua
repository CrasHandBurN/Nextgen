...
patterns = {
	L"После %poi продължете направо, %destname",
	L"После на втория светофар продължете направо, %destname",
	L"После на светофара продължете направо, %destname",
	L"После направо.",
	...
	L"Излезте %3 %then",
	L"После, влезте в магистралата %destname.",
