...
patterns = {
	L"После %poi направо, %destname",
	L"После на втория светофар направо, %destname",
	L"После на светофара направо, %destname",
	L"После направо.",
	...
	L"След %dist На втория светофар направо, %destname  %then5",
	...
	L"после %poi завийте %1 %destname",
	L"после на втория светофар %1 %destname",
	L"после на светофара %1 %destname",
	L"после завийте %3.",
	L"после на третата пресечка %3.",
	L"после на втората пресечка %3.",
	L"после на следващата пресечка %3.",
	...
	L"Завийте %3 %then1",
	L"Завийте %3 %then1",
	L"След %poi рязко %2, %destname",
	L"После на втория светофар рязко %2, %destname",
	L"После на светофара рязко %2, %destname",
	L"После завийте %1 %4.",
	L"После на третата пресечка рязко %4.",
	L"После на втората пресечка рязко %4.",
	L"После направете рязък завой %4.",
	L"След %dist рязък завой %4.",	-- далече
	L"След %dist %poi завийте рязко %2, %destname  %then4",
	L"След %dist На втория светофар рязко %2, %destname  %then5",
	...
	L"След %dist рязко %4 %then1",
	L"На кръстовището %1 %3 %destname %then1",	--повороте
	L"На кръстовището %1 %4 %then1",	--повороте
	L"Завийте %1 %3, %destname  %then1",
	L"Завийте %1 %4 %then1",
	L"След %poi плавно %1, %destname",
	L"После на втория светофар плавно %1, %destname",
	L"После на светофара плавно %1, %destname",
	L"После плавно %3.",
	L"След %dist плавен завой %3.",	-- далече
	...
	L"После дръжте %1 по главния път.",
	L"След %dist дръжте %1 по главния път.",			-- далекче
	L"След %dist %streetname  дръжте %3 %then",
	L"След %dist по главния път, дръжте %3 %then",
	L"Дръжте %1 по главния път %then",
	L"После обърнете, където е възможно.",
	L"Обърнете, където е възможно %then",
	L"После, обърнете %poi.",
	L"После, обърнете на втория светофар.",
	L"После, обърнете на светофара.",
	L"После, обърнете.",
	L"След %dist , направете обратен завой.",
	L"След %dist , направете обратен завой %poi %then4",
	L"След %dist , направете обратен завой на втория светофар %then5",
	L"След %dist , направете обратен завой на светофара %then5",
	L"След %dist , направете обратен завой %then",
	L"Направете обратен завой %then",
	L"После на кръговото, отстъпете пътя",
	L"След %dist се пригответе да влезете в кръговото.",
	L"След %dist на кръговото вземете %exit изход %destname  %then",
	L"След %dist на кръговото вземете %exit изход %then",
	L"След %dist отстъпете пътя при навлизане в кръговото  %destname  %then",
	L"След %dist кръгово движение %then",
	L"На кръговото, отстъпете пътя и излезте от %exit изход %then",
	L"Влезте в кръговото. %then",	--Дорога с круговым движением
	L"После завийте %1 на кръговото.",
	L"След %dist на кръговото завийте %1.",
	L"След %dist на кръговото %1, през %exit изход, %destname  %then",
	L"След %dist на кръговото %1, през %exit изход %then",
	L"След %dist на кръговото %1, %destname  %then",
	L"След %dist на кръговото %1 %then",
	L"На кръговото %1, през %exit изход %then",
	L"На кръговото %1 %then",
	L"После обърнете на кръговото.",
	L"След %dist на кръговото направете обратен завой",			
	L"След %dist обърнете на кръговото, през %exit изход %destname  %then",
	L"След %dist обърнете на кръговото, през %exit изход %then",
	L"След %dist обърнете на кръговото, %destname  %then",
	L"След %dist обърнете на кръговото %then",
	L"Направете обратен завой на кръговото %exit изход %then",
	L"Направете обратен завой на кръговото %then",
	L"После продължете направо през кръговото, като отстъпите пътя.",
	L"След %dist продължете направо през кръговото, като отстъпите пътя, ",
	L"След %dist продължете направо през кръговото, %exit изход, %destname  %then",
	L"След %dist продължете направо през кръговото, %exit изход %then",
	L"След %dist продължете направо през кръговото, %destname  %then",
	L"След %dist продължете направо през кръговото %then",
	L"На кръговото, вземете %exit изход %then",
	L"Направо през кръговото %then",
...
---	L"След %dist излезте на %streetname %then3",			--- на основа от wwt-bull: иначе два пъти "на на"
	L"След %dist следвайте %streetname %then3",			--- на основа от wwt-bull: иначе два пъти "на на"
	L"След %dist влезте в магистралата %then3",
	L"Влезте в магистралата %then3",
	L"После, изход %destname",
	L"После, излезте от магистралата.",
	L"След %dist изход %destname",	-- далече
	...
	L"после на кръстовището завийте %3.",
	...
	L"после вземете %exit изход.",	--затем выполните
	L"после на кръговото %destname",
	L"после %poi направо.",
	L"после на втория светофар направо.",
	L"после на светофара направо.",
	...
	L"след %poi %1.",
	L"после на втория светофар %1.",
	L"после на светофара %1.",
	L"после %3.",
	L"След %dist %3.",
	...
	L"Сега %2 %then1",
	L"след %poi рязко %2.",
	L"после на втория светофар рязко %2.",
	L"после на светофара рязко %2.",
	L"после %1 %4.",
	...
	L"Завийте %1 %3 %then1",
	L"след %poi плавно %1.",
	L"после на втория светофар плавно %1.",
	L"после на светофара плавно %1.",
	...
	L"Дръжте %2 %then",
	L"Обратен завой %poi %then4",
	L"Обратен завой на втория светофар %then5",
	L"после %1 на кръговото",
